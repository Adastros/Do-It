...
function addTaskButtonListener(taskForm) {
  ...
  formAddTaskButton.addEventListener("click", () => {
    ...
    if (primaryTaskBoardHeading !== "Completed") {
      ...
      (0,_webStorageController_js__WEBPACK_IMPORTED_MODULE_4__.saveTaskItem)("inbox", taskItemId, taskItemObj);
    }
  ...
  checkbox.addEventListener("click", () => {
    ...
    if (taskItem.classList.contains("completed")) {
      ...
      if (task.taskType.includes("General")) {
        ...
        // to taskData.
        (0,_webStorageController_js__WEBPACK_IMPORTED_MODULE_4__.saveTaskItem)("inbox", taskItemId, task);
      } else {
