...
function cancelTaskEditListener(taskForm, taskItemId) {
  ...
  formCancelButton.addEventListener("click", () => {
    ...
    // taskItemId exists.
    if (taskItemId) {
      let currentTaskItemObj = (0,_webStorageController_js__WEBPACK_IMPORTED_MODULE_3__.getTaskItem)("taskItemId:" + taskItemId);
...
function addTaskToTaskViewerListener(taskForm, taskItemId) {
  ...
  formAddOrSaveTaskButton.addEventListener("click", () => {
    ...
    (0,_webStorageController_js__WEBPACK_IMPORTED_MODULE_3__.saveTaskItem)(taskItemKey, taskItemObj);
