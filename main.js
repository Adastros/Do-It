...
function addOrSaveTaskButtonListener(taskForm, taskItemId) {
  ...
  formAddOrSaveTaskButton.addEventListener("click", () => {
    ...
    if (!taskItemId) {
      ...
      (0,_webStorageController_js__WEBPACK_IMPORTED_MODULE_4__.deleteTaskItem)(taskItemId);
      taskToRemove.remove();
    }

    (0,_webStorageController_js__WEBPACK_IMPORTED_MODULE_4__.saveTaskItem)(taskItemId, taskItemObj);
...
function addTaskToBoard(taskItemId, taskItemObj, taskBoard) {
  if (!taskItemObj) {
    taskItemObj = (0,_webStorageController_js__WEBPACK_IMPORTED_MODULE_4__.getTaskItem)(taskItemId);
  }
...
function AddEditButtonListener(editButton, taskItemId) {
  editButton.addEventListener("click", () => {
    let currentTaskItemObj = (0,_webStorageController_js__WEBPACK_IMPORTED_MODULE_4__.getTaskItem)(taskItemId);
...
function createDeleteConfirmationOverlayListener(deleteButton, taskItemId) {
  deleteButton.addEventListener("click", () => {
    let taskHeader = (0,_webStorageController_js__WEBPACK_IMPORTED_MODULE_4__.getTaskItem)(taskItemId).headerValue;
...
function toggleTaskCompletion(checkbox, taskItemId) {
  checkbox.addEventListener("click", () => {
    ...
    (0,_webStorageController_js__WEBPACK_IMPORTED_MODULE_4__.saveTaskToCompleted)(taskItemId);
    (0,_webStorageController_js__WEBPACK_IMPORTED_MODULE_4__.deleteTaskItem)(taskItemId);
    taskItem.remove();
  });
}
...
function insertTaskForTodayView(taskItemId, taskItemObj, taskViewer) {
  let taskDueDate = (0,_webStorageController_js__WEBPACK_IMPORTED_MODULE_4__.getTaskPriority)(taskItemObj.dueDateValue),
...
/* harmony export */   "saveTaskToCompleted": () => (/* binding */ saveTaskToCompleted)
/* harmony export */ });
...
function saveTaskToCompleted(taskItemKey) {
  let completedTaskDataObj = JSON.parse(getData("completed")),
    ...
    todaysDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date, "PP");
