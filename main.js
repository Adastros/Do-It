...
function addNewProjectButtonListener() {
  ...
  addNewProjectButton.addEventListener("click", () => {
    ...
    (0,_webStorageController_js__WEBPACK_IMPORTED_MODULE_5__.saveData)(projectName, "{}");
