...
function cancelTaskEditListener(taskForm, taskItemNumber) {
  ...
  formCancelButton.addEventListener("click", () => {
    ...
    if (taskItemNumber !== undefined) {
      let currentTaskItemObj = (0,_webStorageController_js__WEBPACK_IMPORTED_MODULE_3__.getTaskItem)("taskItemNumber" + taskItemNumber);

      taskViewer.insertBefore(
        (0,_appMainContent_task_taskItem_js__WEBPACK_IMPORTED_MODULE_2__.taskItem)(currentTaskItemObj, taskItemNumber),
