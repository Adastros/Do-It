...
function taskDueDateField(taskDueDate) {
  ...
  if (taskDueDate) {
    dateInput.setAttribute(
      "value",
      `${(0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(taskDueDate), "yyyy-MM-dd")}`
    );
  } else {
...
function taskForm(
  ...
  taskDateAndPriorityContainer.append(
    (0,_taskDueDateField_js__WEBPACK_IMPORTED_MODULE_0__.taskDueDateField)(taskDueDate),
...
function taskItem(
  ...
  primaryTaskInfoAndActionsContainer.append(
    ...
    (0,_taskItemActions_js__WEBPACK_IMPORTED_MODULE_2__.taskItemActions)(taskItemNumber)
  );
  taskItem.append(
    primaryTaskInfoAndActionsContainer,
    dueDateAndPriorityIndicatorContainer
  ...
  formCancelButton.addEventListener("click", () => {
    ...
    if (taskItemNumber !== undefined) {
      taskViewer.insertBefore(
        (0,_appMainContent_task_taskItem_js__WEBPACK_IMPORTED_MODULE_2__.taskItem)(
          taskHeaderValue,
          taskDescriptionValue,
          taskItemNumber,
          taskPriorityValue,
...
function addTaskToTaskViewerListener(taskForm, taskItemNumber) {
  ...
  formAddOrSaveTaskButton.addEventListener("click", () => {
    ...
    let taskHeaderValue = taskForm.querySelector("#form-task-header").value,
      ...
      taskDueDateValue = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(
        new Date(
          taskForm
...
function AddEditButtonListener(editButton, taskItemNumber) {
  editButton.addEventListener("click", () => {
    ...
    let taskEditForm = (0,_appMainContent_task_taskForm_js__WEBPACK_IMPORTED_MODULE_0__.taskForm)(
      "Save",
