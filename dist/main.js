...
function saveTaskButtonListener(taskForm, taskItemId) {
  ...
  formAddOrSaveTaskButton.addEventListener("click", () => {
    ...
    (0,_webStorageController_js__WEBPACK_IMPORTED_MODULE_5__.saveTaskItem)(primaryTaskBoardHeading, taskItemId, editedTaskObj);
      ...
      if (!isTaskOverdue(projectDataObj[secondaryKey][taskItemKey])) {
        let taskObj = projectDataObj[secondaryKey][taskItemKey],
          board = document.querySelector(
            `[data-priority-key="${(0,_webStorageController_js__WEBPACK_IMPORTED_MODULE_5__.getTaskPriorityKey)(taskObj.priorityValue)}"]`
          );
