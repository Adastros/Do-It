...
/* harmony export */   "projectTabListeners": () => (/* binding */ projectTabListeners),
...
function projectTabListeners(projectTab) {
  projectTab.addEventListener("mouseover", () => {
    (0,_helper_helper_js__WEBPACK_IMPORTED_MODULE_5__.removeClass)(projectTab.lastElementChild, "hide");
  });

  projectTab.addEventListener("mouseout", () => {
    (0,_helper_helper_js__WEBPACK_IMPORTED_MODULE_5__.addClass)(projectTab.lastElementChild, "hide");
  });
}
...
function projectTab(projectName) {
  ...
  (0,_helper_helper_js__WEBPACK_IMPORTED_MODULE_5__.addClass)(deleteButton, "hide");
  ...
  (0,_controls_menuController_js__WEBPACK_IMPORTED_MODULE_1__.projectTabListeners)(projectTab);
