...
// function checkForEmptyTaskBoards() {
//   let taskBoards = document.getElementsByClassName("secondary-task-board");

//   taskBoards.forEach((board) => {
//     if (!board.querySelector(".task-list").firstElementChild) {
//       board.remove();
//     }
//   });
// }
