...
function taskForm(addOrSaveTaskButtonText, currentTaskItemObj) {
  ...
  taskDateAndPriorityContainer.append(
    ...
    (0,_taskPriorityDropdown_js__WEBPACK_IMPORTED_MODULE_1__.taskPriorityDropdown)()
  );
...
function taskPriorityDropdown() {
  let taskPriorityDropdown = (0,_helper_helper_js__WEBPACK_IMPORTED_MODULE_0__.createElement)("div"),
    ...
    noPriorityOption = (0,_helper_helper_js__WEBPACK_IMPORTED_MODULE_0__.createElement)("option"),
    lowPriorityOption = (0,_helper_helper_js__WEBPACK_IMPORTED_MODULE_0__.createElement)("option"),
    mediumPriorityOption = (0,_helper_helper_js__WEBPACK_IMPORTED_MODULE_0__.createElement)("option"),
    highPriorityOption = (0,_helper_helper_js__WEBPACK_IMPORTED_MODULE_0__.createElement)("option");
...
function toggleMenubarVisibility() {
  ...
  menuButton.addEventListener("click", () => {
    ...
    (0,_helper_helper_js__WEBPACK_IMPORTED_MODULE_5__.toggleClass)(mainContent, "closed");
  });
}
...
function sortByInboxTasks(filteredLocalStorageData) {
  filteredLocalStorageData.forEach((key) => {
    (0,_taskController_js__WEBPACK_IMPORTED_MODULE_3__.addTaskToTaskViewer)(key);
  });
}
...
function sortByTodaysTasks(filteredLocalStorageData) {
  ...
  filteredLocalStorageData.forEach((key) => {
    ...
    let taskItemObj = (0,_webStorageController_js__WEBPACK_IMPORTED_MODULE_4__.getTaskItem)(key);
...
function sortByUpcomingTasks(filteredLocalStorageData) {
  ...
  filteredLocalStorageData.forEach((key) => {
    ...
    if ((0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(taskDueDate, weekFromTodaysDate) < 7) {
      (0,_taskController_js__WEBPACK_IMPORTED_MODULE_3__.addTaskToTaskViewer)(key);
    }
  });
}
...
function createMenuTabListener(menuTab) {
  menuTab.addEventListener("click", () => {
    ...
    if (localStorage.previousMenuTab !== tabName) {
      (0,_taskController_js__WEBPACK_IMPORTED_MODULE_3__.removeAllTasks)();
...
function initLocalStorageGlobalVariables() {
  (0,_components_controls_webStorageController_js__WEBPACK_IMPORTED_MODULE_6__.saveTaskItem)("previousMenuTab", "");
}
