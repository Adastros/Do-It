...
function emptyTaskBoardMessage() {
  ...
  taskLists.forEach((list) => {
    let emptyTaskBoardMessage = (0,_helper_helper_js__WEBPACK_IMPORTED_MODULE_7__.createElement)("p");

    emptyTaskBoardMessage.textContent = "There are no tasks due on this date.";
    (0,_helper_helper_js__WEBPACK_IMPORTED_MODULE_7__.addClass)(emptyTaskBoardMessage, "empty-date-task-board-msg");
