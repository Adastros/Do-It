...
function checkbox(taskItemId) {
  ...
  (0,_controls_taskController_js__WEBPACK_IMPORTED_MODULE_0__.setTaskCompleted)(checkbox, taskItemId);
...
/* harmony export */   "setTaskCompleted": () => (/* binding */ setTaskCompleted),
...
function saveTaskToCompleted(taskItemKey) {
  let completedTaskDataObj = JSON.parse(getData("completed")),
    ...
    todaysDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date, "MMM d - EEEE");
